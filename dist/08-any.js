"use strict";
(() => {
    let myDynamicVar; //tipado explícito a any, que significa cualquier valor, rompe la rigurosidad que supone el tipado de typescript
